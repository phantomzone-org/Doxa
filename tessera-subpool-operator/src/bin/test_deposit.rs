...
//! 5. Creates and signs a `depositAndRegister(noteCommitment, amount)` tx WITHOUT broadcasting (the
//!    operator will broadcast it later)
...
async fn main() -> Result<()> {
	...
	let deposit_amount: u64 = env_or("DEPOSIT_AMOUNT", "1000")
		.parse()
