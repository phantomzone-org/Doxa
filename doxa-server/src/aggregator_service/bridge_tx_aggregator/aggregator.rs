...
use doxa_client::{PIHelper, BRIDGE_TX_BATCH_SIZE, SUBTREE_BATCHSIZE};
use doxa_utils::{
	groth::DoxaGeneratorSerializer, hasher::HashOutput, CircuitDataNative, ConfigNative,
	ProofNative, D, F,
};
...
impl PairLeafCircuit {
	...
	fn store_artifacts(
		...
		let gen_ser = DoxaGeneratorSerializer;
