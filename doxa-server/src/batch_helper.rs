use anyhow::Result;
use doxa_client::{HashOutput, PIHelper, SUBTREE_BATCHSIZE};
use doxa_utils::F;
...
impl PiCommitHash for SolidityKeccak256 {
	fn hash(words: &[u32]) -> [u8; 32] {
		use doxa_utils::plonky2_gadgets::keccak256::utils::solidity_keccak256;
...
#[cfg(test)]
mod tests {
	use doxa_client::FakeSpendTxBuilder;
	...
	fn pi_commitment_output_is_32_bytes() {
		use doxa_client::build_priv_tx_circuit;
