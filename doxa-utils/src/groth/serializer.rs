//! Custom [`WitnessGeneratorSerializer`] for the Doxa native circuit.
//!
...
//! [`DoxaGeneratorSerializer`] which covers all 24 standard generators
...
/// generators and the 10 custom generators used by Doxa's Keccak-256 /
/// SHA-256 / u32 gadgets.
///
...
pub struct DoxaGeneratorSerializer;

impl WitnessGeneratorSerializer<F, D> for DoxaGeneratorSerializer {
	plonky2::impl_generator_serializer! {
		...
		SplitGenerator,
		WireSplitGenerator,
		// --- 10 custom Doxa generators (Keccak-256 / SHA-256 / u32 gadgets) ---
		ByteDecompositionGenerator,
		ChunkDecompositionGenerator,
		U16LimbDecompositionGenerator,
		LimbByteDecompositionGenerator,
