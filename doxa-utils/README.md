...
Shared primitives for the Doxa workspace: Plonky2/STARK gadgets, a Keccak-256 in-circuit implementation, Groth16 wrapping via Go FFI, and common type aliases.
