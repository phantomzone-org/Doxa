...
- Account table:
  - stored fields of Account instance (check doxa-client `StandardAccount` struct for respective fields).
...
- User table:
  - stores user related information:
    ...
    - physical_address
    - DOB
    - private_acc_address: private account address (hex representation of struct AccountAddress in doxa-client)
