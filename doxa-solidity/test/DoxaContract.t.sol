...
import {DoxaContract} from "../src/DoxaContract.sol";
...
contract DoxaRollupV2Test is Test {
    DoxaContract public rollup;
    ...
    function _deploy(uint256 depth) internal returns (DoxaContract) {
        return
            new DoxaContract(
    ...
    function _deployRejectTx(uint256 depth) internal returns (DoxaContract) {
        return
            new DoxaContract(
    ...
    // -----------------------------------------------------------------------
    // Goldilocks encoding helpers (mirrors DoxaContract internals)
    // -----------------------------------------------------------------------

    /// @dev Mirrors DoxaContract._glHashToBytes.
    ...
    /// @dev Mirrors DoxaContract._glFieldToBytes.
    ...
    function _dummyProof()
        internal
        pure
        returns (DoxaContract.Proof memory p)
    {
    ...
    function test_appendLeaf_treeFullReverts() public {
        ...
        vm.expectRevert(DoxaContract.TreeFull.selector);
    ...
    function test_submit_happy() public {
        ...
        emit DoxaContract.TransactionBatchSubmitted(pic, bpr);
    ...
    function test_submit_unknownRoot() public {
        ...
        vm.expectRevert(
            abi.encodeWithSelector(
                DoxaContract.RootNotConfirmed.selector,
                unknown
            )
        );
        rollup.submitTransactionBatch(preimage);
    ...
    function test_submit_wrongPoolConfig() public {
        ...
        vm.prank(OP);
        vm.expectRevert(DoxaContract.PoolConfigMismatch.selector);
        rollup.submitTransactionBatch(preimage);
    }
    ...
    function test_submit_nullifierAlreadyUsed() public {
        ...
        vm.expectRevert(
            abi.encodeWithSelector(
                DoxaContract.NullifierAlreadyUsed.selector,
                _glH(knownNullifier)
            )
        );
    ...
    function test_submit_duplicate() public {
        ...
        vm.expectRevert(
            abi.encodeWithSelector(
                DoxaContract.BatchAlreadySubmitted.selector,
                pic
            )
        );
        rollup.submitTransactionBatch(preimage);
    ...
    function test_submit_notOperator() public {
        ...
        vm.prank(ALICE);
        vm.expectRevert(DoxaContract.NotOperator.selector);
        rollup.submitTransactionBatch(preimage);
    }
    ...
    function test_submit_whenPaused() public {
        ...
        bytes memory preimage = _minBatch(0x9999);
        vm.prank(OP);
        vm.expectRevert(DoxaContract.PausedErr.selector);
        rollup.submitTransactionBatch(preimage);
    }
    ...
    function test_prove_unknownPiCommitment() public {
        ...
        vm.expectRevert(
            abi.encodeWithSelector(DoxaContract.BatchNotFound.selector, pic)
        );
    ...
    function test_prove_alreadyConfirmed() public {
        ...
        vm.expectRevert(
            abi.encodeWithSelector(
                DoxaContract.BatchAlreadyConfirmed.selector,
                pic
            )
        );
        rollup.proveTransactionBatch(preimage, _dummyProof());
    ...
    function test_prove_invalidProof() public {
        DoxaContract bad = _deployRejectTx(DEPTH);
        ...
        vm.expectRevert(
            abi.encodeWithSelector(
                DoxaContract.ProofVerificationFailed.selector,
                pic,
                inputs
            )
        );
    ...
    function test_deposit_happy() public {
        ...
        vm.expectEmit(true, false, false, true, address(rollup));
        emit DoxaContract.DepositAvailable(nc, amount, ALICE, ASSET_ID);
        vm.prank(ALICE);
        rollup.depositAndRegister(nc, ASSET_ID, amount);

        DoxaContract.Deposit memory d = rollup.getDeposit(nc);
        assertEq(d.value, amount);
        assertEq(d.recipient, ALICE);
        assertEq(uint8(d.status), uint8(DoxaContract.DepositStatus.Pending));
    ...
    function test_withdraw_pending() public {
        ...
        assertEq(
            ...
            uint8(DoxaContract.DepositStatus.Withdrawn)
        );
    ...
    function test_withdraw_nonRecipient() public {
        ...
        vm.expectRevert(DoxaContract.NotDepositRecipient.selector);
        rollup.withdrawPendingDeposit(nc);
    }
    ...
    function test_submitBridgeTxBatch_validatesPendingDeposits() public {
        ...
        assertEq(
            uint8(rollup.getDeposit(nc).status),
            uint8(DoxaContract.DepositStatus.Pending)
        );
    }
    ...
    function test_submitBridgeTxBatch_rejectsMissingNote() public {
        ...
        vm.expectRevert(
            abi.encodeWithSelector(
                DoxaContract.NoteNotFound.selector,
                bytes32(noteKey)
            )
        );
    ...
    function test_proveBridgeTxBatch_marksDepositValidated() public {
        ...
        assertEq(
            uint8(rollup.getDeposit(nc).status),
            uint8(DoxaContract.DepositStatus.Validated),
    ...
    function test_setOperator() public {
        ...
        emit DoxaContract.OperatorChanged(OP, newOp);
    ...
    function test_txPiCommitment_roundTrip() public {
        ...
        emit DoxaContract.TransactionBatchSubmitted(
            expected,
            _glH(0x1234567890)
        );
        rollup.submitTransactionBatch(preimage);
    ...
    function test_withdrawalDelay() public {
        ...
        DoxaContract delayed = new DoxaContract(
            address(acceptVerifier),
            address(acceptVerifier),
            address(poseidon),
            OP,
        ...
        vm.expectRevert(
            abi.encodeWithSelector(
                DoxaContract.WithdrawalTooEarly.selector,
                nc,
                block.number + 10
            )
        );
    ...
    function test_assignSubpoolOwner_rejectsZero() public {
        vm.prank(OP);
        vm.expectRevert(DoxaContract.SubpoolIdZero.selector);
...
contract GasMeasureTest is DoxaRollupV2Test {
