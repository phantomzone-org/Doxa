...
import { fetchUnderReviewOutputNotes, reviewOutputNote } from "../api/admin";
...
export function OutputNotesUnderReviewPage() {
  const {
    data,
    isLoading,
    isError,
    ...
    queryKey: ["output-notes-underreview"],
    queryFn: fetchUnderReviewOutputNotes,
