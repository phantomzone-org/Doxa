...
import { fetchAllDeposits } from "../api/admin";
import type { DepositAdminRow } from "../types";
...
function DepositRow({ row }: { row: DepositAdminRow }) {
...
export function DepositsPage() {
  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      {data && data.length === 0 && (
        <div className="py-16 text-center text-slate-400">No deposits yet.</div>
      )}
      {data && data.length > 0 && (
