...
contract TesseraRollupV2Test is Test {
    ...
    function _deploy(uint256 depth) internal returns (TesseraRollupV2) {
        return new TesseraRollupV2(
    ...
    function _deployRejectTx(uint256 depth) internal returns (TesseraRollupV2) {
        return new TesseraRollupV2(
    ...
    function _dummyProof() internal pure returns (TesseraRollupV2.Proof memory p) {
    ...
    function _minBatch(TesseraRollupV2 r, uint256 bpr)
        internal
        returns (TesseraRollupV2.TransactionBatch memory b)
    {
    ...
    function _minBatch(uint256 bpr) internal returns (TesseraRollupV2.TransactionBatch memory) {
    ...
    function _appendTo(TesseraRollupV2 r, uint256 bpr) internal returns (bytes32 pic) {
        TesseraRollupV2.TransactionBatch memory b = _minBatch(r, bpr);
        vm.prank(OP);
    ...
    function test_appendLeaf_treeFullReverts() public {
        ...
        TesseraRollupV2 small = _deploy(1);
        _appendTo(small, 0x4001);
        _appendTo(small, 0x4002);

        TesseraRollupV2.TransactionBatch memory b = _minBatch(small, 0x4003);
        vm.prank(OP);
        small.submitTransactionBatch(b);
        bytes32 pic = _txPI(b);

        vm.expectRevert(TesseraRollupV2.TreeFull.selector);
    ...
    function test_submit_happy() public {
        TesseraRollupV2.TransactionBatch memory b = _minBatch(uint256(0x9999));
        bytes32 pic = _txPI(b);

        vm.expectEmit(true, false, false, true, address(rollup));
        emit TesseraRollupV2.TransactionBatchSubmitted(pic, b.batchPoseidonRoot);
    ...
    function test_submit_wrongPoolConfig() public {
        ...
        vm.prank(OP);
        vm.expectRevert(TesseraRollupV2.PoolConfigMismatch.selector);
        rollup.submitTransactionBatch(b);
    }
    ...
    function test_submit_duplicate() public {
        TesseraRollupV2.TransactionBatch memory b = _minBatch(0x7777);
        bytes32 pic = _txPI(b);
        ...
        vm.prank(OP);
        vm.expectRevert(abi.encodeWithSelector(TesseraRollupV2.BatchAlreadySubmitted.selector, pic));
        rollup.submitTransactionBatch(b);
    }

    /// Non-operator caller reverts NotOperator.
    function test_submit_notOperator() public {
        TesseraRollupV2.TransactionBatch memory b = _minBatch(0x8888);
        vm.prank(ALICE);
        vm.expectRevert(TesseraRollupV2.NotOperator.selector);
        rollup.submitTransactionBatch(b);
    }
    ...
    function test_submit_whenPaused() public {
        ...
        TesseraRollupV2.TransactionBatch memory b = _minBatch(0x9999);
        vm.prank(OP);
        vm.expectRevert(TesseraRollupV2.PausedErr.selector);
        rollup.submitTransactionBatch(b);
    }
    ...
    function test_prove_happy() public {
        ...
        TesseraRollupV2.TransactionBatch memory b = _minBatch(bpr);
        bytes32 pic = _txPI(b);
        vm.prank(OP);
        rollup.submitTransactionBatch(b);
        rollup.proveTransactionBatch(pic, _dummyProof());
    ...
    function test_prove_unknownPiCommitment() public {
        ...
        vm.expectRevert(abi.encodeWithSelector(TesseraRollupV2.BatchNotFound.selector, fake));
    ...
    function test_prove_alreadyConfirmed() public {
        TesseraRollupV2.TransactionBatch memory b = _minBatch(0xBBBB);
        bytes32 pic = _txPI(b);
        vm.prank(OP);
        rollup.submitTransactionBatch(b);
        rollup.proveTransactionBatch(pic, _dummyProof());

        vm.expectRevert(abi.encodeWithSelector(TesseraRollupV2.BatchAlreadyConfirmed.selector, pic));
        rollup.proveTransactionBatch(pic, _dummyProof());
    }

    /// Invalid proof reverts ProofVerificationFailed.
    function test_prove_invalidProof() public {
        TesseraRollupV2 bad = _deployRejectTx(DEPTH);
        TesseraRollupV2.TransactionBatch memory b = _minBatch(bad, 0xCCCC);
        bytes32 pic = _txPI(b);
        vm.prank(OP);
        bad.submitTransactionBatch(b);

        uint256[8] memory inputs = bad.keccakToPublicInputs(pic);
        vm.expectRevert(abi.encodeWithSelector(TesseraRollupV2.ProofVerificationFailed.selector, pic, inputs));
    ...
    function test_prove_permissionless() public {
        TesseraRollupV2.TransactionBatch memory b = _minBatch(0xDDDD);
        bytes32 pic = _txPI(b);
        vm.prank(OP);
        rollup.submitTransactionBatch(b);
    ...
    function test_deposit_happy() public {
        ...
        vm.expectEmit(true, false, false, true, address(rollup));
        emit TesseraRollupV2.DepositAvailable(nc, amount, ALICE);
        vm.prank(ALICE);
        rollup.depositAndRegister(nc, amount);

        TesseraRollupV2.Deposit memory d = rollup.getDeposit(nc);
        assertEq(d.value, amount);
        assertEq(d.recipient, ALICE);
        assertEq(uint8(d.status), uint8(TesseraRollupV2.DepositStatus.Pending));
    ...
    function test_withdraw_pending() public {
        ...
        assertEq(uint8(rollup.getDeposit(nc).status), uint8(TesseraRollupV2.DepositStatus.Withdrawn));
    ...
    function test_withdraw_nonRecipient() public {
        ...
        vm.expectRevert(TesseraRollupV2.NotDepositRecipient.selector);
        rollup.withdrawPendingDeposit(nc);
    }
    ...
    function test_submitDepositBatch_validatesNotes() public {
        ...
        assertEq(uint8(rollup.getDeposit(nc1).status), uint8(TesseraRollupV2.DepositStatus.Pending));
    }
    ...
    function test_submitDepositBatch_rejectsMissingNote() public {
        ...
        vm.prank(OP);
        vm.expectRevert(abi.encodeWithSelector(TesseraRollupV2.NoteNotFound.selector, missing));
    ...
    function test_proveDepositBatch_marksValidated() public {
        ...
        assertEq(uint8(rollup.getDeposit(nc1).status), uint8(TesseraRollupV2.DepositStatus.Validated));
        assertEq(uint8(rollup.getDeposit(nc2).status), uint8(TesseraRollupV2.DepositStatus.Validated));
    ...
    function test_withdraw_afterValidated() public {
        ...
        vm.prank(ALICE);
        vm.expectRevert(abi.encodeWithSelector(TesseraRollupV2.InvalidDepositState.selector, nc));
        rollup.withdrawPendingDeposit(nc);
    }
    ...
    function test_setOperator() public {
        ...
        emit TesseraRollupV2.OperatorChanged(OP, newOp);
    ...
    function test_setPaused_blocksSubmit() public {
        ...
        TesseraRollupV2.TransactionBatch memory b = _minBatch(1);
    ...
    function test_setPoolConfigRoot() public {
        ...
        vm.prank(OP);
        vm.expectEmit(true, true, false, false, address(rollup));
        emit TesseraRollupV2.PoolConfigRootUpdated(PCR, newPCR);
