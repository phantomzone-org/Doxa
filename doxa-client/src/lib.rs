...
//! to participate in the Doxa privacy protocol:
//!
...
pub use plonky2_gadgets::serialization::DoxaGateSerializer;
pub mod pool_config;
pub mod schnorr;
pub(crate) mod utils;

pub use account::*;
pub use doxa_utils::hasher::HashOutput;
use doxa_utils::{ConfigNative, D, F, HASH_SIZE};
pub use note::*;
pub use plonky2_gadgets::{
	deposit_tx::{
		DepositProof, DepositTxCircuit, build_deposit_tx_circuit, builder::FakeDepositTxBuilder,
	},
	priv_tx::{
	...
	withdraw_tx::{
		WithdrawProof, WithdrawTxCircuit, build_withdraw_tx_circuit, builder::FakeWithdrawTxBuilder,
	},
};
...
pub fn sample_dummy_notes<R: rand::CryptoRng>(
	rng: &mut R,
...
// TODO: set this to H("doxa::account::ast::emptyLeaf")
...
// this is set to H("doxa::account::commitment::consumePk::placeholder"). It's not a valid point
// on the curve
...
// this is set to random point on the curve with seed H("doxa::account::spend::defaultSpendKey").
...
/// `H("doxa::account::spend::defaultSpendKey")`.
