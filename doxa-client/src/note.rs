...
///
/// The deposit note specifies which Doxa account should receive the funds
...
pub struct DepositNote {
	...
	/// The Doxa account address that will receive the deposit.
...
///
/// Notes are the primary transfer primitive in Doxa.  A sender creates a
