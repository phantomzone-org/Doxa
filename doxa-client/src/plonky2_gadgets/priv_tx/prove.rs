...
fn build_circuit_and_proof_inner(
	not_fake_tx: bool,
) -> (doxa_utils::CircuitDataNative, doxa_utils::ProofNative) {
...
fn build_circuit_and_proof_seeded(
	...
	let circuit = builder.build::<doxa_utils::ConfigNative>();
...
fn prove_priv_tx_inner(
	circuit: &doxa_utils::CircuitDataNative,
	t: &PrivTxTargets<{ doxa_utils::D }>,
	not_fake_tx: bool,
	seed: u64,
...
pub fn build_priv_tx_circuit() -> (
	doxa_utils::CircuitDataNative,
	PrivTxTargets<{ doxa_utils::D }>,
) {
	use plonky2::plonk::{circuit_builder::CircuitBuilder, circuit_data::CircuitConfig};
	use doxa_utils::hasher::HashOutput;
...
pub fn prove_priv_tx(
	circuit: &doxa_utils::CircuitDataNative,
	targets: &PrivTxTargets<{ doxa_utils::D }>,
	inputs: PrivTxInputs,
) -> doxa_utils::ProofNative {
