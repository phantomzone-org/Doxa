...
pub mod tx_super_aggregator_v2;
...
pub use deposit_super_aggregator_v2::{
	...
	DEPOSIT_NOTE_COMM_OFFSET, ETH_ADDR_LEN, ETH_ADDR_OFFSET,
};
pub use generic::{
...
pub use tx_super_aggregator_v2::{
	validate_subtree_nc_offcircuit, SuperAggregator, SuperAggregatorV2CircuitData, IS_REAL_OFFSET,
	TX_DATA_OFFSET, TX_LEAF_PI_SIZE,
};
