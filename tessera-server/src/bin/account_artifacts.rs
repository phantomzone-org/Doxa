//! Generate account-circuit artifacts for `/accounts/commitment` proof validation.
//!
//! Produces a trivial 8-PI Plonky2 circuit (account commitment + nullifier key,
//! each encoded as 4 Goldilocks u64 fields) and saves three files to
...
//!
//! Usage:
//!   cargo run --bin account_artifacts --release
...
fn main() -> Result<()> {
	...
	println!("account artifacts: {}", out_dir.display());
